...
import com.flink.stream.real.service.real.hour.HourJdbcSink;
import com.flink.stream.real.service.real.hour.HourKeySelector;
...
public class HourController {
  ...
  public static void main(String[] args) throws Exception {
    ...
    DataStream<RealResult> result =
        temp
            // 根据指定时间格式yyyy-MM-dd-HH进行分组
            .keyBy(new HourKeySelector())
            // 开滚动窗口
    ...
    result.printToErr();
    // 输出mysql
    result.addSink(new HourJdbcSink());
