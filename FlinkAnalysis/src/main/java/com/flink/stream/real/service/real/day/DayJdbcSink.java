package com.flink.stream.real.service.real.day;
 ...
 */
public class DayJdbcSink extends RichSinkFunction<RealResult> {
  ...
  public void open(Configuration parameters) throws Exception {
    ...
    // 创建sql对象
    String insertSql = "insert into real_day (create_time,pv,uv) values (?,?,?);";
    String updateSql = "update real_day set pv = ?, uv = ? where create_time = ?;";
